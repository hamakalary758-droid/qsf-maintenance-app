      ...
      <div className="space-y-3">
        ...
        {actions.length === 0 ? (
          ...
          <div className="space-y-2.5">
            {actions.map((ca, idx) => (
              <div key={ca.id} className="p-3 bg-white border border-slate-200 rounded-xl space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-500 uppercase">Action #{idx + 1}</span>
                  <button
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs text-slate-800 focus:outline-none focus:bg-white focus:ring-2 focus:ring-sky-500"
                />
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                  ...
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-0.5">Target Date</label>
                    <input
                      type="date"
                      value={ca.targetDate}
        ...
        {spareParts.length === 0 ? (
          ...
          <div className="space-y-2.5">
            {spareParts.map((sp, idx) => (
              <div key={sp.id} className="p-3 bg-white border border-slate-200 rounded-xl space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-500 uppercase">Part #{idx + 1}</span>
                  <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <input
                    ...
                    className="bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs text-slate-800 font-mono"
                  />
                </div>
