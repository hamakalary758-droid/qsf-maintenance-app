...
export const BasicInfoStep: React.FC<BasicInfoStepProps> = ({ reportData, onChange }) => {
  return (
    <div className="space-y-4 animate-fadeIn">
      <div className="bg-[var(--accent-dim)] border border-[var(--accent)]/30 rounded-xl p-3.5 text-xs text-[var(--text-0)] flex items-start space-x-2">
        ...
        <div>
          ...
          <p className="text-[11px] text-[var(--text-1)] mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {/* Technician Name */}
        <div>
          <label className="block text-xs font-bold text-[var(--text-1)] mb-1 flex items-center space-x-1">
          ...
          <input
            ...
            className="w-full bg-[var(--panel-solid)] border border-[var(--panel-border)] rounded-lg px-3 py-2 text-xs text-[var(--text-0)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent"
          />
        </div>
        ...
        <div>
          <label className="block text-xs font-bold text-[var(--text-1)] mb-1 flex items-center space-x-1">
            <Calendar className="w-3.5 h-3.5 text-[var(--text-2)]" />
        ...
        <div>
          <label className="block text-xs font-bold text-[var(--text-1)] mb-1 flex items-center space-x-1">
            <Wrench className="w-3.5 h-3.5 text-[var(--text-2)]" />
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[var(--panel-solid)] border border-[var(--panel-border)] rounded-lg px-3 py-2 text-xs text-[var(--text-0)] font-mono focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full bg-[var(--panel-solid)] border border-[var(--panel-border)] rounded-lg px-3 py-2 text-xs text-[var(--text-0)] font-medium focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent"
        >
