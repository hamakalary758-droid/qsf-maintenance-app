    ...
    <div className="space-y-4 animate-fadeIn">
      <div className="bg-purple-50 border border-purple-200 rounded-xl p-3.5 text-xs text-purple-900 flex items-start justify-between">
        <div className="flex items-start space-x-2">
          ...
          <div>
            <strong className="font-bold">Step 3: 5-Why Root Cause Analysis</strong>
            ...
            <React.Fragment key={step.key}>
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-[10px] text-slate-400 font-mono">{step.prompt}</span>
                </div>
                ...
                <textarea
                  ...
                  className={`w-full p-2.5 text-xs rounded-lg border focus:outline-none focus:ring-2 resize-none ${
                    isRootCause
                      ? 'bg-white border-rose-200 text-slate-900 focus:ring-rose-500 font-medium'
                      : 'bg-slate-50 border-slate-200 text-slate-800 focus:bg-white focus:ring-sky-500'
                  }`}
                />
              </div>
